...
type
  GUIKeymod* = enum
    ...
    Mod_Status_Caps
    Mod_Status_Numpad
  # Event Modifiers Bitflags
  GUIKeymods* = set[GUIKeymod]
...
{.compile: "keymap.c".}
{.push header: "keymap.h".}

type
  GUIKeymask* {.importc: "nogui_keymask_t".} = distinct cuint
  GUIKeycode* {.size: 4, pure, importc: "nogui_keycode_t".} = enum
    NK_Unknown = 0x0
    Button_Left = 0x1
    Button_Right = 0x2
    Button_Middle = 0x3
...
# Keycode String Name
proc name*(code: GUIKeycode): cstring
  {.importc: "nogui_keycode_name".}
